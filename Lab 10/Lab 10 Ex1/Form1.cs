...
namespace lab10t1
{
    public partial class Form1 : Form
    {
        ...
        {
            TTrianglePrizm trg = new TTrianglePrizm(Convert.ToDouble(textBox1.Text), Convert.ToDouble(textBox2.Text), Convert.ToDouble(textBox3.Text), Convert.ToDouble(textBox11.Text));

            textBox12.Text = trg.capacitPrizm().ToString();
        }

        private void button9_Click(object sender, EventArgs e)
        {
            TTrianglePrizm trg = new TTrianglePrizm(Convert.ToDouble(textBox1.Text), Convert.ToDouble(textBox2.Text), Convert.ToDouble(textBox3.Text), Convert.ToDouble(textBox11.Text));
            textBox13.Text = trg.perimeterPrizm().ToString();
        }

        private void button10_Click(object sender, EventArgs e)
        {
            TTrianglePrizm trg = new TTrianglePrizm(Convert.ToDouble(textBox1.Text), Convert.ToDouble(textBox2.Text), Convert.ToDouble(textBox3.Text), Convert.ToDouble(textBox11.Text));
            textBox14.Text = trg.areaPrizm().ToString();
        }
    }
}
